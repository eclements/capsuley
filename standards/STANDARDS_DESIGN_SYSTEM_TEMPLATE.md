...
<!-- Include 2–3 complete, real-world component examples that combine multiple patterns. These "golden examples" give agents a concrete target when building similar UI. -->
...
- **Colour config:** `impulsy-app/tailwind.config.js` + `impulsy-app/src/styles.scss`
- **Global styles:** `impulsy-app/src/styles.scss`
